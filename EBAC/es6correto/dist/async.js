...
function _execucaoPrincipal() {
  _execucaoPrincipal = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
    var resultado, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          ...
          promiseComParametros('felipelanga95@gmail.com', 123456).then(function (resultado) {
